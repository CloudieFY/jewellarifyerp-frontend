...
export default function GoldRatesPage() {
  ...
  const cards = [
    ...
    { key: "gold20" as const, label: "20K Gold", tone: "from-orange-100 to-orange-50" },
    { key: "gold18" as const, label: "18K Gold", tone: "from-rose-100 to-rose-50" },
          ...
          <CardContent className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="20K Gold" stroke="#c2410c" strokeWidth={3} fill="url(#color20k)" dot={chartData.length === 1} activeDot={{ r: 6, strokeWidth: 0, fill: '#c2410c' }} />
